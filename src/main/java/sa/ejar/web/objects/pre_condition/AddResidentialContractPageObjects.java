...
//            put ("ar", "  ");
        ...
        put("search-contract-number-input-field", new HashMap<>() {{
            put("en", "//app-custom-data-list[@formcontrolname='contract_number']/descendant::input");
            put("ar", "//app-custom-data-list[@formcontrolname='contract_number']/descendant::input");
        }});
