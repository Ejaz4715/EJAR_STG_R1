...
public class SubleaseContract extends NHCWebTest {

    @Test(dataProvider = "testDataProvider")
    public void CommercialSubleaseContractMoreThan3Months(Map<String, String> data) throws Exception {
        ...
        logger.info("Step 06: Navigate to Financial > Input annual rent > Select Payment >select IBAN > Select account owner > Continue");
        ...
        app.createNewCommercialContractPage.clickContinueFinancialTermsBTN(data.get("EnableSecurityDeposit"), data.get("SecurityAmount"));
    ...
    @Test(dataProvider = "testDataProvider")
    public void ApproveCommercialSubleaseByLessorMoreThan3Months(Map<String, String> data) throws Exception {
        data.putAll(TestDataManager.readDependantGlobalTestData("Contracts"));
        logger.info("Step 00: Test Data : " + data);
        app.openApplication(data);
...
//        CommonMethodsPage.clickOnConfirmButton();
    ...
    @Test(dataProvider = "testDataProvider")
    public void ApproveCommercialSubleaseByTenantMoreThan3Months(Map<String, String> data) throws Exception {
        data.putAll(TestDataManager.readDependantGlobalTestData("Contracts"));
        logger.info("Step 00: Test Data : " + data);
        app.openApplication(data);
    ...
    @Test(dataProvider = "testDataProvider")
    public void CommercialSubleaseContractLessThan3Month(Map<String, String> data) throws Exception {
        data.putAll(TestDataManager.readDependantGlobalTestData("Contracts"));
        logger.info("Step 00: Test Data : " + data);
        app.openApplication(data);
        logger.info("Step 01: Login to Application Enter Email, Enter Password, click Login");
    ...
    @Test(dataProvider = "testDataProvider")
    public void ApproveCommercialSubleaseByLessorLessThan3Months(Map<String, String> data) throws Exception {
        data.putAll(TestDataManager.readDependantGlobalTestData("Contracts"));
        logger.info("Step 00: Test Data : " + data);
        app.openApplication(data);
        logger.info("Step 01: As Lessor Enter Email, Password > click Login");
...
//        CommonMethodsPage.clickOnConfirmButton();
    ...
    @Test(dataProvider = "testDataProvider")
    public void ApproveCommercialSubleaseByTenantLessThan3Months(Map<String, String> data) throws Exception {
        data.putAll(TestDataManager.readDependantGlobalTestData("Contracts"));
        logger.info("Step 00: Test Data : " + data);
        app.openApplication(data);
        logger.info("Step 01: As Tenant Enter Email, Password > click Login");
    ...
    @Test(dataProvider = "testDataProvider")
    public void ResidentialSubleaseContractMoreThan3Months(Map<String, String> data) throws Exception {
        data.putAll(TestDataManager.readDependantGlobalTestData("Contracts"));
        logger.info("Step 00: Test Data : " + data);
        app.openApplication(data);
    ...
    @Test(dataProvider = "testDataProvider")
    public void ApproveResidentialSubleaseByLessorMoreThan3Months(Map<String, String> data) throws Exception {
        data.putAll(TestDataManager.readDependantGlobalTestData("Contracts"));
        logger.info("Step 00: Test Data : " + data);
        app.openApplication(data);
        logger.info("Step 01: As Lessor Enter Email, Password > click Login");
...
//        CommonMethodsPage.clickOnConfirmButton();
    ...
    @Test(dataProvider = "testDataProvider")
    public void ApproveResidentialSubleaseByTenantMoreThan3Months(Map<String, String> data) throws Exception {
        data.putAll(TestDataManager.readDependantGlobalTestData("Contracts"));
        logger.info("Step 00: Test Data : " + data);
        app.openApplication(data);
        logger.info("Step 01: As Tenant Enter Email, Password > click Login");
    ...
    @Test(dataProvider = "testDataProvider")
    public void ResidentialSubleaseContractLessThan3Months(Map<String, String> data) throws Exception {
        data.putAll(TestDataManager.readDependantGlobalTestData("Contracts"));
        logger.info("Step 00: Test Data : " + data);
        app.openApplication(data);
        logger.info("Step 01: Login to Application Enter ID/Username, Enter Password, click Login");
    ...
    @Test(dataProvider = "testDataProvider")
    public void ApproveResidentialSubleaseByLesserLessThan3Months(Map<String, String> data) throws Exception {
        data.putAll(TestDataManager.readDependantGlobalTestData("Contracts"));
        logger.info("Step 00: Test Data : " + data);
        app.openApplication(data);
        logger.info("Step 01: As Lessor Enter Email, Password > click Login");
...
//        CommonMethodsPage.clickOnConfirmButton();
    ...
    @Test(dataProvider = "testDataProvider")
    public void ApproveResidentialSubleaseByTenantLessThan3Months(Map<String, String> data) throws Exception {
        data.putAll(TestDataManager.readDependantGlobalTestData("Contracts"));
        logger.info("Step 00: Test Data : " + data);
        app.openApplication(data);
        logger.info("Step 01: As Tenant Enter Email, Password > click Login");
